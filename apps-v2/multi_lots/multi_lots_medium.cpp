...
int main(int argc, char **argv) {
    ...
    const int sum_size = 100; // shared dimension between A and B 
    ...
    Halide::Buffer<float> A_ (512,100,100);
    Halide::Buffer<float> B_ (100,500,100);
    Halide::Buffer<float> D_ (512, 500,100);
    ...
    prod(k, i, j, ll) = A(i, k, ll) * B(k, j, ll);
